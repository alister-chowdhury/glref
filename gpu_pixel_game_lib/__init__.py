...
DEBUG_CHAR0_MOVING_VERT = os.path.join(_SHADER_DIR, "playing", "debug_char0_moving.vert")
DEBUG_CHAR0_MOVING_FRAG = os.path.join(_SHADER_DIR, "playing", "debug_char0_moving.frag")
